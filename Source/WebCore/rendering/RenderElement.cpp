...
std::optional<FloatRect> RenderElement::referenceBoxFloatRect(CSSBoxType boxType) const
{
    // CSS box model code is implemented in RenderBox::referenceBoxLayoutRect().
