...
FloatPoint3D RenderStyle::applyTransformOrigin(TransformationMatrix& transform, const FloatRect& boundingBox, OptionSet<RenderStyle::TransformOperationOption> options) const
{
...
{
    auto originTranslate = applyTransformOrigin(transform, boundingBox, options);
...
void RenderStyle::applyCSSTransform(TransformationMatrix& transform, const FloatRect& boundingBox, OptionSet<RenderStyle::TransformOperationOption> options) const
{
    ...
    // 2. Translate by the computed X, Y, and Z values of transform-origin. (see applyTransformOrigin)
...
void RenderStyle::setFontFamilies(RefCountedFixedVector<AtomString>& families)
{
    FontSelector* currentFontSelector = fontCascade().fontSelector();
    auto description = fontDescription();
    description.setFamilies(families);
