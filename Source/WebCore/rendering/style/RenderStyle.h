...
public:
    ...
    void applyTransform(TransformationMatrix&, const FloatRect& boundingBox, OptionSet<TransformOperationOption> = allTransformOperations, WTF::Function<AffineTransform()>&& externalAffineTransformationSource = { }) const;
